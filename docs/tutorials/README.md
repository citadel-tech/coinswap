...
- **Custom signet faucet**: Remember that the [Custom Signet Faucet](http://s2ncekhezyo2tkwtftti3aiukfpqmxidatjrdqmwie6xnf2dfggyscad.onion/) typically requires access via the Tor browser.
- **DNS server marketplace**: The DNS server marketplace for other networks is currently not available.
