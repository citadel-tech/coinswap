...
//! - Initialize a UnifiedTaker instance with Bitcoin Core RPC
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    use coinswap::{
        ...
        taker::{UnifiedSwapParams, UnifiedTaker, UnifiedTakerConfig},
    ...
    // Initialize Taker using the unified API with builder-style config
    ...
    let taker = UnifiedTaker::init(config).unwrap();
    ...
    let swap_params = UnifiedSwapParams {
