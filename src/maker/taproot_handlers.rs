...
fn process_taproot_contract<M: UnifiedMaker>(
    ...
    #[cfg(feature = "integration-test")]
    {
        ...
        if maker.behavior() == UnifiedMakerBehavior::CloseAtContractSigsExchange {
            log::warn!(
...
fn process_taproot_handover<M: UnifiedMaker>(
    ...
    {
        use super::unified_handlers::UnifiedMakerBehavior;
        if maker.behavior() == UnifiedMakerBehavior::CloseAtPrivateKeyHandover {
            log::warn!(
    ...
    {
        use super::unified_handlers::UnifiedMakerBehavior;
        if maker.behavior() == UnifiedMakerBehavior::CloseAfterSweep {
            log::warn!(
