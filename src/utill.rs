...
// when making a new Bip324Stream`
...
pub(crate) struct Bip324Stream {
    pub stream: bip324::io::Protocol<std::io::BufReader<TcpStream>, TcpStream>,
...
impl Bip324Stream {
    pub fn new(
        ...
        let writer = stream;
        let stream = bip324::io::Protocol::new(
            network.magic(),
            bip324_role,
            None,
    ...
    /// Sends a CBOR-serializes message and sends it as a genuine BIP324 payload.
