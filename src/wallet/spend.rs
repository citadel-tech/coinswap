...
use super::swapcoin::SwapCoin;
use super::{error::WalletError, Wallet};
use super::{IncomingSwapCoin, OutgoingSwapCoin};
...
impl Wallet {
    ...
    /// - If [Destination::Multi] is used, a custom amount is sent to each address, and any remaining funds
