...
const TEST_CASES: &[(u64, &[u64], u64)] = &[
    (54_082, &[9091, 46824, 53245, 3919], 4), // CASE A : Threshold -> 2 Targets, 2 Changes
    (102_980, &[100000, 3919, 65658, 38012], 4), // CASE B : Threshold -> 2 Targets, 2 Changes
    (708_742, &[298092, 107831, 100000, 70000, 46824, 38012, 35892, 9091, 3919, 712971], 4), // CASE C.1 : Threshold -> 2 Targets, 2 Changes
    // (500_000, &[91379, 65658, 38012, 301909, 3919, 432441, 70000], 4), // CASE C.2 : Deterministic -> 2 Targets, 2 Changes
    (654_321, &[298092, 100000, 91379, 65658, 53245, 46824, 9091, 35892, 70000, 109831, 432441], 4), // Edge Case A for the UTXO set
    (90_000, &[38012, 53245, 9091, 35892, 46824], 4), // Edge Case B
    (10_000, &[9091, 3919], 4), // Gradual scaling targets
    (100_000, &[65658, 35892, 46824, 53245], 4), // OR  &[38012, 65658, 100000] Edge Case C. Will investigate
    (1_000_000, &[432441, 298092, 100000, 70000, 53245, 38012, 9091, 91379, 109831, 800000], 4),
    // (7_777_777, &[46824, 1992436, 1000000, 712971, 9091, 91379, 38012, 900000, 800000, 1946436, 65658, 70000, 107831], 3), // Odd, lopsided amounts
    (888_888, &[432441, 109831, 107831, 91379, 65658, 46824, 35892, 38012, 800000, 53245], 4),
    (999_999, &[432441, 298092, 100000, 70000, 53245, 38012, 9091, 91379, 800000, 109831], 4), // Near-round numbers
    (123_456, &[3919, 35892, 38012, 46824, 65658, 53245, 9091], 4), // Non-round numbers
    (250_000, &[46824, 38012, 91379, 65658, 9091, 107831, 109831, 35892], 4), // Large, uneven splits
