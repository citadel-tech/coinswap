...
const TEST_CASES: &[(u64, &[u64], u64)] = &[
    ...
    (102_980, &[3919, 35892, 65658, 107831], 4), // CASE B : Threshold -> 2 Targets, 2 Changes
    (708_742, &[91379, 107831, 109831, 100000, 301909, 46824, 70000, 53245, 432441, 38012, 3919, 65658], 4), // CASE C.1 : Threshold -> 2 Targets, 2 Changes
    (500_000, &[301909, 53245, 100000, 46824, 35892, 65658, 9091, 91379, 298092], 4), // CASE C.2 : Deterministic -> 2 Targets, 2 Changes
    (654_321, &[91379, 301909, 109831, 100000, 53245, 432441, 65658, 35892, 3919, 46824, 70000], 4), // Edge Case A for the UTXO set
    (90_000, &[9091, 46824, 35892, 53245, 38012], 4), // Edge Case B
    ...
    (1_000_000, &[900000, 35892, 53245, 3919, 9091, 1000000], 4),
    //(7_777_777, &[1992436, 107831, 900000, 1000000, 800000, 298092, 53245, 65658, 1946436, 100000, 46824, 38012, 432441], 3),TODO: fails because of nondeterministic UTXO selection
    (999_999, &[9091, 53245, 900000, 35892, 3919, 1000000], 4), // Near-round numbers
    (123_456, &[46824, 3919, 9091, 65658, 53245, 70000], 4), // Non-round numbers
    (250_000, &[46824, 3919, 91379, 109831, 107831, 35892, 70000, 38012], 4), // Large, uneven splits
    //(7_500_000, &[3919, 46824, 100000, 712971, 1946436, 900000, 800000, 1000000, 1992436], 3),TODO: nondeterministic UTXO selection
