//! Integration test: Taproot maker abort2 - Maker drops at private key handover.
//!
...
fn test_taproot_maker_abort2() {
    ...
    let maker_behaviors = vec![
        ...
        UnifiedMakerBehavior::CloseAtPrivateKeyHandover,
    ];
    ...
    log::info!("Starting Taproot maker abort2 test...");
    ...
    // so 90s ~ 300 blocks -- more than enough for the CSV timelock.
